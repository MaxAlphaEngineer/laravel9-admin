        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-8">
                            <div class="text-sm-end">
                                <a href="<?php echo e(route('permissions.create')); ?>" type="button"
                        ...
                        <table class="table align-middle table-nowrap mb-lg-5">
                            ...
                            <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <p class="mb-0"><?php echo e($permission->title); ?></p>
                                    </td>



                                    </td>
                                    <td><?php echo e(date('j-F, Y ', strtotime($permission->created_at))); ?></td>
                                    <td>
                    ...
                    <?php echo e($permissions->links('components.pagination')); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/muzaffarmakhkamov/PhpstormProjects/laravel9/resources/views/dashboard/permission/index.blade.php ENDPATH**/ ?>